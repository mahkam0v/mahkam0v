...
## 💻 About Me
- 🚀 Currently specializing in building robust, high-performance server-side architectures.
- ⚙️ Deeply interested in relational database design, efficient API structures, and clean code principles.
- 🐧 Proud Arch Linux user who enjoys terminal customization and task automation.
